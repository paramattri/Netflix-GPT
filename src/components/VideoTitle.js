...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="pl-2 md:pl-11 absolute bg-gradient-to-r from-black w-screen aspect-video pt-40">
      <h1 className="text-white text-2xl md:text-5xl font-bold">{title}</h1>
      <p className="text-white hidden md:block md:text-lg w-1/3 mt-4">
        {overview}
      </p>
